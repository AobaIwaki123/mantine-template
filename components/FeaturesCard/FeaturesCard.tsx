  ...
  return (
    <Card shadow="sm" padding="lg" radius="md" withBorder>
      ...
      <Group justify="space-between" mt="md" mb="xs">
        ...
        >
          NUC # 330 - "Generation Team Challenge: Cooking Queen Battle ③" 2021/10/10 NUC # 330 -
          "Generation Team Challenge: Cooking Queen Battle ③" 2021/10/10 NUC # 330 - "Generation
          Team Challenge: Cooking Queen Battle ③" 2021/10/10
        </Text>
